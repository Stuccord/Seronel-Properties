  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      <section className="py-24 bg-card border-y border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Why Ghana Real Estate?</h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto">A stable economy, growing diaspora demand, and massive infrastructure developments make Ghana the ultimate investment destination.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background p-8 rounded-3xl border border-white/5 hover:border-primary/50 transition-all group">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Unmatched ROI</h3>
              <p className="text-white/60 leading-relaxed">Prime lands in Accra and surrounding areas appreciate between 15% and 25% annually. Build equity faster than traditional markets.</p>
            </div>
            ...
            <div className="bg-background p-8 rounded-3xl border border-white/5 hover:border-primary/50 transition-all group relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 relative z-10">Political Stability</h3>
              <p className="text-white/60 leading-relaxed relative z-10">Ranked among the safest countries in Africa. Secure your investments in a robust democracy with strong property rights.</p>
            </div>
            ...
            <div className="bg-background p-8 rounded-3xl border border-white/5 hover:border-primary/50 transition-all group">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Diaspora Boom</h3>
              <p className="text-white/60 leading-relaxed">Initiatives like "Year of Return" have fueled massive demand for high-quality housing and verified lands from international buyers.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Visualizing Your <span className="text-primary">Returns</span></h2>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-white/80">Average <strong className="text-white">20% annual appreciation</strong> on serviced plots.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="w-6 h-6 text-primary mr-3 shrink-0 mt-0.5" />
                  <span className="text-white/80">Rental yields for modern apartments average <strong className="text-white">8-12%</strong> per year.</span>
                </li>
                <li className="flex items-start">
                  <CheckCircle2 className="w-6 h-6 text-primary mr-3 shrink-0 mt-0.5" />
                  <span className="text-white/80">Hedge against inflation with tangible, dollar-pegged assets.</span>
                </li>
              </ul>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-card p-8 rounded-3xl border border-white/10 shadow-2xl relative">
                <div className="flex justify-between items-end mb-8">
                  <div>
                    <h4 className="text-white font-bold text-xl">Property Appreciation Example</h4>
                    <p className="text-white/40 text-sm">Based on a $50,000 initial land investment</p>
                  </div>
                ...
                <div className="flex items-end justify-between h-64 gap-2 sm:gap-4 relative border-b border-white/10 pb-4">
                  {/* Y-axis labels */}
                  <div className="absolute left-0 top-0 bottom-4 flex flex-col justify-between text-xs text-white/40 font-mono hidden sm:flex">
                    <span>$100k</span>
                    <span>$75k</span>
                    <span>$50k</span>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-end group sm:ml-12">
                    <div className="w-full bg-primary/20 rounded-t-lg relative transition-all duration-500 group-hover:bg-primary/40 h-[20%]">
                      <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">$50k</div>
                    </div>
                    <span className="text-white/60 text-sm mt-4 font-medium">Year 1</span>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-end group">
                    <div className="w-full bg-primary/40 rounded-t-lg relative transition-all duration-500 group-hover:bg-primary/60 h-[45%]">
                      <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">$62k</div>
                    </div>
                    <span className="text-white/60 text-sm mt-4 font-medium">Year 3</span>
                  </div>
                  
                  <div className="flex-1 flex flex-col items-center justify-end group">
                    <div className="w-full bg-primary/60 rounded-t-lg relative transition-all duration-500 group-hover:bg-primary/80 h-[70%]">
                      <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-white font-bold opacity-0 group-hover:opacity-100 transition-opacity">$80k</div>
                    </div>
                    <span className="text-white/60 text-sm mt-4 font-medium">Year 5</span>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-end group">
                    ...
                    <span className="text-white font-bold text-sm mt-4 text-primary">Year 7</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-card border-y border-white/5 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Where Should You Invest?</h2>
            <p className="text-white/60 text-lg max-w-2xl mx-auto">Compare your options to find the strategy that fits your portfolio goals.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-background rounded-3xl p-8 border border-white/5 hover:border-white/20 transition-colors">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-3xl font-bold text-white">Serviced Land</h3>
              </div>
            ...
            <div className="bg-background rounded-3xl p-8 border border-white/5 hover:border-white/20 transition-colors">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-3xl font-bold text-white">Completed Homes</h3>
              </div>
              <ul className="space-y-4 mb-8 text-white/70">
      ...
      <section className="py-24 bg-background">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-4xl font-bold text-white mb-6">Flexible Payment Plans</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="glass p-6 rounded-2xl border border-white/10">
              <h4 className="text-white font-bold text-xl mb-2">Outright Payment</h4>
              <p className="text-white/60 text-sm">Enjoy up to 10% discount for immediate full settlement.</p>
            </div>
            <div className="glass p-6 rounded-2xl border border-white/10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-white font-bold text-xl mb-2">6-12 Months</h4>
                <p className="text-white/60 text-sm">Spread the balance comfortably over a year with zero interest.</p>
              </div>
            </div>
            <div className="glass p-6 rounded-2xl border border-white/10">
              <h4 className="text-white font-bold text-xl mb-2">24 Months</h4>
              <p className="text-white/60 text-sm">Extended mortgage-style payments for premium properties.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="invest-form" className="py-24 relative overflow-hidden bg-card border-t border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center flex flex-col items-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Start Your Investment Journey</h2>
          ...
          <div className="flex justify-center">
            <a href="https://wa.me/1234567890?text=Hello%20LuxeEstates,%20I'm%20ready%20to%20invest." target="_blank" rel="noreferrer" className="inline-flex items-center justify-center glass text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all border border-white/20">
